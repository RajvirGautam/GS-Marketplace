const Icons = {
  ...
  Apron: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M20 20v-6a2 2 0 0 0-2-2h-4V4H6v10H4a2 2 0 0 0-2 2v6"/>
      <path d="M10 4v8"/>
      <path d="M14 4v8"/>
    </svg>
  ),
  ...
  SolderingIron: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M18.36 5.64 15.54 8.46a2.83 2.83 0 0 0 0 4l4.24 4.24"/>
      <path d="M8.46 15.54l-4.24 4.24a2 2 0 0 1-2.83 0v0a2 2 0 0 1 0-2.83l4.24-4.24"/>
      <path d="M2 2l20 20"/>
    </svg>
  ),
  Notebook: () => (
  ...
  LogicGate: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 8h4"/>
      <path d="M2 16h4"/>
      <path d="M6 4h6a6 6 0 0 1 0 12H6"/>
      <path d="M18 10h4"/>
  ...
  LaptopCode: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <polyline points="16 12 13 9 16 6"/>
    </svg>
  ),
  ...
  // Make sure 'X' is also there if you haven't added it yet
...
Zap: (props) => (
  ...
  // ... Add other existing category icons here if you need them ...
...
// Add these to your Icons object:
Check: (props) => (
  <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
